...
<div align="center">
    ...
    <h2 class="w3-center w3-blue" style="width: 300px">Rejestracja</h2>
    <form:form  method="POST" action="/register" modelAttribute="user"
               class="w3-container w3-card-4 w3-light-grey w3-text-blue w3-margin w3-center" cssStyle="width: 300px">
    ...
    <div style="width: 250px" class="w3-row w3-section w3-center">
        ...
        <div class="w3-rest">
            <input class="w3-button w3-ripple w3-centerw 3-container w3-card-4 w3-light-grey w3-text-blue w3-margin" name="submit" type="submit" value="Add"/>
        </div>
    </div>
    </form:form>
    <div style="width: 300px" class="w3-row w3-section w3-center">
        <div class="w3-col" style="width:50px"><i class="w3-xxlarge "></i></div>
        <div class="w3-rest">
            <a href="/login" class="w3-button w3-blue w3-ripple w3-center">Powrót do logowania</a>
        </div>
    </div>
</div>
</div>
